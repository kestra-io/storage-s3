...
# Kestra Storage Plugin for Amazon S3

<p align="center">
  <img width="460" src="https://kestra.io/logo.svg"  alt="Kestra workflow orchestrator" />
</p>

Plugin to store namespace files and temporary task outputs to a private S3 bucket for scalability, security and privacy reasons.
